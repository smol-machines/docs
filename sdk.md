...
- [TypeScript local machine](https://github.com/smol-machines/smol/blob/v1.15.0/sdk/node/examples/basic.ts)
- [TypeScript cloud machine](https://github.com/smol-machines/smol/blob/v1.15.0/sdk/node/examples/cloud.ts)
- [Python cloud machine](https://github.com/smol-machines/smol/blob/v1.15.0/sdk/python/examples/cloud.py)
