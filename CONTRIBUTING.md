...
page under `content/`, press **`.`** or click the pencil icon, edit, and choose
...
3. Edit the relevant file under `content/`.
4. Commit, push to your fork, and open a pull request against `main`.

## How files map to pages

A file at `content/<path>.md` is served at `/docs/<path>`:

| File | URL |
|---|---|
| `content/index.md` | `/docs/` |
| `content/local.md` | `/docs/local` |
| `content/introduction/concepts/smolfile.md` | `/docs/introduction/concepts/smolfile` |
...
1. Create `content/<section>/<your-page>.md` with `title` frontmatter.
