...
The [docker-in-machine](/docs/local/skills/docker-in-machine) skill packet is this procedure with that reapplication built into the start step, and it asserts which filesystem Docker's root landed on.
